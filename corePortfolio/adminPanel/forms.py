...
class AboutForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'areaofResearch': forms.TextInput(
                attrs={'class': 'form-control', 'placeholder': 'example: Python engineer'}),
...
class BlogForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'tags': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'enter tags ex. (IT, Business,'
                                                                                   ' Accounts)'}),
            'quote': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'enter a "Quote" regarding post'}),
            'quote_by': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'who said this quote ex. (sohaib langrial)'}),
            'description': forms.Textarea(attrs={'class': 'form-control', 'placeholder': 'Write your post'}),
